    ...
    <Box>
      ...
      <section className='banner_bottom py-md-5'>
        <div className='container py-4 mt-2'>
          ...
          <p className='tit text-center mx-auto'>
            Bolt Parcel Express is the largest consumer-to-consumer package
          ...
          <div className='inner_sec_info_wthree_agile pt-4 mt-4'>
            <div className='row help_full'>
              ...
              <div className='col-md-6 banner_bottom_left ourteam'>
                <h4>
                BPExpress was founded with the goal
                 of making parcel delivery simple and 
                 convenient for everyone. We understand
                  that shipping can be a hassle, which 
                  is why we offer a wide range of services 
                  to suit your needs. From express shipping 
                  for time-sensitive packages, to cost-effective 
                  ground shipping for larger items, we have a 
                  solution for every situation. Our team of 
      ...
      <section className='team py-md-5'>
        <div className='container py-4'>
          ...
          <p className='tit text-center mx-auto'>
            Learn about the management personnel leading and growing Bolt Supply
            Chain today
          </p>
          <div className='row inner-sec-w3layouts-agileinfo pt-4 mt-md-4'>
            ...
            <div className='col-md-3 col-sm-6 team-grids'>
              ...
              <div className='team-info'>
                <div className='caption'>
                  <h4>
                    Hendrik Venter, CEO Europe, Middle East & Africa, BPExpress
                    Supply Chain
                  </h4>
                  <h6>
            ...
            <div className='col-md-3 col-sm-6 team-grids'>
              ...
              <div className='team-info'>
                <div className='caption'>
                  <h4>Terry Ryan, CEO Asia Pacific, BPExpress Supply Chain </h4>
                  <h6>
                    ...
                    achievements include launching a start-up logistics in Australia.
                  </h6>
                </div>
              </div>
            </div>
